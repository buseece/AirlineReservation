        ...
        <?php
            ...
            if ($conn->connect_error) {
                ...
                if($result->num_rows >0){
                    ?>
                    <form action = "http://localhost/Airline/empEditRes2.php" method="post">
                    <?php

                    //Get the data
                    $row = $result->fetch_assoc();
                    ?>
                    Are you sure you want to update the following Reservation? <br/>
                    ...
                    <p>Flight ID: <input type="text" name="FlightID" value="<?php echo $row["FlightID"]?>" readonly /></p>
                     <p>Customer ID: <input type="text" name="CustID" value="<?php echo $row["CustID"]?>" readonly /></p>
                      ...
                      <p>New Seat: <input type="text" name="NewSeat" value=""  /></p>
                   <p><input type="submit" value="Update Reservation"  /></p>
                   </form>
                   <?php
                }else{
